...
if fastSim.isChosen():
    ecalSelectiveReadoutValidation.EbSimHitCollection = cms.InputTag("fastSimProducer","EcalHitsEB")
    ecalSelectiveReadoutValidation.EeSimHitCollection = cms.InputTag("fastSimProducer","EcalHitsEE")
